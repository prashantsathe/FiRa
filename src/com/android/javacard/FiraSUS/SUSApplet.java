...
import static com.android.javacard.FiraSUS.Constants.CURRENT_PACKAGE_VERSION;
import static com.android.javacard.FiraSUS.Constants.INS_ERASE_RDS;
import static com.android.javacard.FiraSUS.Constants.INS_EXT_MUT_AUTH;
import static com.android.javacard.FiraSUS.Constants.INS_GET_RDS_DATA;
import static com.android.javacard.FiraSUS.Constants.INS_INT_AUTH;
import static com.android.javacard.FiraSUS.Constants.INS_PSO;
import static com.android.javacard.FiraSUS.Constants.INS_SELECT;
import static com.android.javacard.FiraSUS.Constants.RDS_MAX_DATA_SIZE;
import static com.android.javacard.FiraSUS.Constants.STORE_RDS_PERSISTENT_FLAG;
import static com.android.javacard.FiraSUS.Constants.SUS_GP_SECURITY_LEVEL;
import static com.android.javacard.FiraSUS.Constants.TEMP_BUF_SIZE;
...
public class SUSApplet extends Applet
    ...
    public short createRangingDataSet(byte[] inBuffer, short inOffset, short inLength,
        ...
        short uwbSessionIdOffset = mSusRDSstorage.parseAndVerifyRangingDataSet(slotId, inBuffer,
                inOffset, inLength);
        ...
        // so we should get slotId if above function return.
    ...
    public Shareable getShareableInterfaceObject(AID clientAID, byte parameter) {
        ...
        for (short i = 0; i < SUPPORTED_APPLET_AIDS.length; i++) {
            if (0 == Util.arrayCompare(mTempBuffer, (short) 0, (byte[]) SUPPORTED_APPLET_AIDS[i],
                    (short) 0, aidLength))
                return this;
        }
