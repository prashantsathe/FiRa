...
public class FiraSpecs {
    ...
    public static final byte[] FIRA_APPLET_AID = { (byte) 0xA0, (byte) 0x00, (byte) 0x00,
            (byte) 0x08, (byte) 0x67, (byte) 0x46, (byte) 0x41, (byte) 0x50, (byte) 0x00 };
    final static byte[] TAG_APPLET_OID = { (byte) 0x06, (byte) 0x09, (byte) 0xA0, (byte) 0x00,
            (byte) 0x00, (byte) 0x08, (byte) 0x67, (byte) 0x46, (byte) 0x41, (byte) 0x50,
            (byte) 0x00 };
    ...
    // sec ranging(variable size session key info + session key info + additional
    // params)
    ...
    public static final short IMPL_MAX_SECURE_RANGING_INFO_SIZE = 64
            + IMPL_MAX_SUS_ADDITIONAL_PARAMS_SIZE;
    ...
    // Command routing size - totally a guess, as this depends on Service Applet
    // APDUs
    ...
    public static final short MAX_FIRA_SC_ASYMMETRIC_KEY_SET_SIZE = (short) (2
            * IMPL_MAX_FIRA_CERT_SIZE);
    // estimated maximum Asymmetric key set
    public static final short MAX_FIRA_SC_SYMMETRIC_KEY_SET_SIZE = 45;
    // Upto two key sets.
    public static final short MAX_FIRA_SC_CRED_SIZE = (short) (2
            * MAX_FIRA_SC_ASYMMETRIC_KEY_SET_SIZE);
    ...
    // Root Controlee info size = capability + ranging + version(2) + tags and len
    // overhead 8
    private static final short MAX_ROOT_UWB_CONTROLEE_INFO_SIZE = (short) (MAX_UWB_CAPABILITY_SIZE
            + MAX_UWB_REGULATORY_SIZE + 16);
    // Controlee info per slot Does not contain capability and ranging data
    // per slot size = pref(4+4+16x1) + static sts (8) + sec ranging + overhead of
    // tags and slot
    // pref is same as UWB MAX CAPABILITY
    public static final short MAX_UWB_CONTROLEE_INFO_SIZE_PER_SLOT = (short) (MAX_UWB_CAPABILITY_SIZE
            + IMPL_MAX_SECURE_RANGING_INFO_SIZE + 16);
    // size per slot = config(64)+ overhead (64) + sec range + regulatory + 8
    public static final short MAX_UWB_SESSION_DATA_SIZE = 136 + IMPL_MAX_SECURE_RANGING_INFO_SIZE
            + MAX_UWB_REGULATORY_SIZE;
    ...
    static final short IMPL_SHARED_ADF_DATA_MAX_SIZE = (short) (MAX_ROOT_UWB_CONTROLEE_INFO_SIZE
            + (IMPL_PA_LIST_CERT_MAX_SIZE * IMPL_PA_LIST_MAX_COUNT));
    static final short IMPL_APPLET_SPECIFIC_DATA_MAX_SIZE = (short) (IMPL_MASTER_KEY_MAX_SIZE
            + IMPL_APPLET_CERT_MAX_SIZE + IMPL_APPLET_SECRET_MAX_SIZE + IMPL_DEVICE_UID_MAX_SIZE
            + IMPL_CONFIG_OPTIONS_MAX_SIZE);
    ...
    public static final short[] DATA_PA_RECORD = { TAG_PA_CRED_PA_ID,
            (short) (MANDATORY | MAX | 30), NO_IDX, TAG_PA_CRED_PA_CRED_TYPE,
            (short) (MANDATORY | 1), ENUM_PA_CRED_TYPE_IDX, TAG_PA_CRED_PA_CREDS,
            (short) (MANDATORY | MAX | 65), NO_IDX, };
    ...
    public static final short TAG_STORED_ADF_PROVISIONING_CRED = (short) 0xBF7F; // This is custom
                                                                                 // tag
    public static final short[] DATA_CREATE_ADF = { TAG_OID,
            (short) (MANDATORY | MAX | MAX_OID_SIZE), NO_IDX, TAG_ADF_PROVISIONING_CRED,
    ...
    public static final short[] STRUCT_ADF_PROVISIONING_CRED = { TAG_ADF_PROV_SYMMETRIC_KEY_SET,
            (short) (CONDITIONAL | MAX | 42), STRUCT_ADF_PROV_SYMMETRIC_KEY_SET_IDX,
    ...
    public static final short[] ENUM_ADF_PROV_SYMMETRIC_CH_ID = { VAL_SC1, VAL_SC2, };
    public static final short[] ENUM_ADF_PROV_ASYMMETRIC_CH_ID = { VAL_SC2, VAL_GP_SCP11c, };
    public static final short VAL_ECC_NIST_P_256 = (short) 0x01;
    public static final short[] ENUM_ADF_PROV_CH_KEY_TYPE = { VAL_ECC_NIST_P_256, };
    ...
    // ADF structure
    public static final short[] STRUCT_ADF = { TAG_OID, (short) (MANDATORY | MAX | MAX_OID_SIZE),
            NO_IDX, TAG_INSTANCE_ID, (short) (CONDITIONAL | MAX | MAX_INSTANCE_ID_SIZE), NO_IDX,
            TAG_UWB_CONTROLEE_INFO,
            (short) (CONDITIONAL | MAX | MAX_UWB_CONTROLEE_INFO_SIZE_PER_SLOT),
            STRUCT_UWB_CONTROLEE_INFO_IDX, TAG_UWB_SESSION_DATA,
            (short) (CONDITIONAL | MAX | MAX_UWB_SESSION_DATA_SIZE), STRUCT_UWB_SESSION_DATA_IDX,
            ...
            STRUCT_ADF_PROVISIONING_CRED_IDX, TAG_FIRA_SC_CRED,
            (short) (MANDATORY | UNORDERED | MAX | MAX_FIRA_SC_CRED_SIZE), STRUCT_FIRA_SC_CRED_IDX,
            TAG_EXTENDED_OPTIONS, (short) (OPTIONAL | 4), NO_IDX, TAG_SERVICE_DATA,
            (short) (OPTIONAL | MAX | IMPL_MAX_SERVICE_DATA_SIZE), NO_IDX, TAG_CMD_ROUTE_INFO,
            (short) (OPTIONAL | MAX | IMPL_MAX_CMD_ROUTE_INFO_SIZE),
    ...
    public static final short[] STRUCT_MANAGE_ADF_CMD_ROUTE_INFO = { TAG_SERVICE_APPLET_ID,
            (short) (MANDATORY | MAX | 16), NO_IDX, };
    public static final short TAG_CMD_ROUTE_SESSION_ID = (short) 0x80;
    public static final short[] STRUCT_CMD_ROUTING_DATA = { TAG_OID,
            (short) (MANDATORY | MAX | MAX_OID_SIZE), NO_IDX, TAG_CMD_ROUTE_SESSION_ID,
            (short) (OPTIONAL | 4), NO_IDX, TAG_CMD_ROUTING_DATA,
            (short) (OPTIONAL | MAX | IMPL_MAX_CMD_ROUTE_INFO_SIZE), NO_IDX, };
    public static final short VAL_APP = (short) 0x00;
    public static final short VAL_SERVICE_APPLET = (short) 0x01;
    public static final short[] ENUM_CMD_ROUTING_TARGET = { VAL_APP, VAL_SERVICE_APPLET, };
    public static final short[] STRUCT_CMD_ROUTE_INFO = { TAG_CMD_ROUTING_TARGET,
            (short) (MANDATORY | 1), ENUM_CMD_ROUTING_TARGET_IDX, TAG_CMD_ROUTING_DATA,
            (short) (MANDATORY | MAX | 290), STRUCT_CMD_ROUTING_DATA_IDX, };
    ...
    public static final short[] DATA_MANAGE_ADF_CMD = { TAG_UWB_CONTROLEE_INFO,
            (short) (CONDITIONAL | MAX | MAX_UWB_CONTROLEE_INFO_SIZE_PER_SLOT),
            STRUCT_UWB_CONTROLEE_INFO_IDX, TAG_ACCESS_CONDITIONS,
            (short) (OPTIONAL | MAX | MAX_ACCESS_CONDITIONS_SIZE), NO_IDX, TAG_FIRA_SC_CRED,
            (short) (CONDITIONAL | UNORDERED | MAX | MAX_FIRA_SC_CRED_SIZE),
            STRUCT_FIRA_SC_CRED_IDX, TAG_APP_DATA_OBJECTS,
            (short) (OPTIONAL | MAX | IMPL_MAX_SERVICE_DATA_SIZE), NO_IDX, TAG_INSTANCE_ID,
            (short) (OPTIONAL | MAX | MAX_INSTANCE_ID_SIZE), NO_IDX, TAG_EXTENDED_OPTIONS,
            (short) (OPTIONAL | 4), NO_IDX, TAG_CMD_ROUTE_INFO,
            (short) (OPTIONAL | MAX | IMPL_MAX_CMD_ROUTE_INFO_SIZE),
    ...
    public static final short[] STRUCT_UWB_CAPABILITY = { TAG_FIRA_PHY_VERSION_RANGE,
            (short) (MANDATORY | 4), NO_IDX, TAG_FIRA_MAC_VERSION_RANGE, (short) (MANDATORY | 4),
            NO_IDX, TAG_DEVICE_ROLES, (short) (OPTIONAL | 1), NO_IDX, TAG_RANGING_METHOD,
            (short) (OPTIONAL | 1), NO_IDX, TAG_STS_CONFIG, (short) (OPTIONAL | 1), NO_IDX,
            TAG_MULTI_NODE_MODE, (short) (OPTIONAL | 1), NO_IDX, TAG_RANGING_TIME_STRUCT,
            (short) (OPTIONAL | 1), NO_IDX, TAG_SCHEDULED_MODE, (short) (OPTIONAL | 1), NO_IDX,
            TAG_HOPPING_MODE, (short) (OPTIONAL | 1), NO_IDX, TAG_BLOCK_STRIDING,
            (short) (OPTIONAL | 1), NO_IDX, TAG_UWB_INITIATION_TIME, (short) (OPTIONAL | 1), NO_IDX,
            TAG_CHANNELS, (short) (OPTIONAL | 1), NO_IDX, TAG_RFRAME_CONFIG, (short) (OPTIONAL | 1),
            NO_IDX, TAG_CC_CONSTRAINT_LENGTH, (short) (OPTIONAL | 1), NO_IDX,
            TAG_BPRF_PARAMETER_SETS, (short) (OPTIONAL | 1), NO_IDX, TAG_HPRF_PARAMETER_SETS,
            (short) (OPTIONAL | 5), NO_IDX, TAG_AOA_SUPPORT, (short) (OPTIONAL | 1), NO_IDX,
            TAG_EXTENDED_MAC_ADDRESS, (short) (OPTIONAL | 1), NO_IDX, };
    public static final short TAG_UWB_CONTROLEE_PREF = (short) 0xA7;
    public static final short[] STRUCT_UWB_CONTROLEE_PREF = { TAG_DEVICE_ROLES,
            (short) (OPTIONAL | 1), NO_IDX, TAG_RANGING_METHOD, (short) (OPTIONAL | 1), NO_IDX,
            TAG_STS_CONFIG, (short) (OPTIONAL | 1), NO_IDX, TAG_MULTI_NODE_MODE,
            (short) (OPTIONAL | 1), NO_IDX, TAG_RANGING_TIME_STRUCT, (short) (OPTIONAL | 1), NO_IDX,
            TAG_SCHEDULED_MODE, (short) (OPTIONAL | 1), NO_IDX, TAG_HOPPING_MODE,
            (short) (OPTIONAL | 1), NO_IDX, TAG_BLOCK_STRIDING, (short) (OPTIONAL | 1), NO_IDX,
            TAG_UWB_INITIATION_TIME, (short) (OPTIONAL | 1), NO_IDX, TAG_CHANNELS,
            (short) (OPTIONAL | 1), NO_IDX, TAG_RFRAME_CONFIG, (short) (OPTIONAL | 1), NO_IDX,
            TAG_CC_CONSTRAINT_LENGTH, (short) (OPTIONAL | 1), NO_IDX, TAG_BPRF_PARAMETER_SETS,
            (short) (OPTIONAL | 1), NO_IDX, TAG_HPRF_PARAMETER_SETS, (short) (OPTIONAL | 5), NO_IDX,
            TAG_AOA_SUPPORT, (short) (OPTIONAL | 1), NO_IDX, TAG_EXTENDED_MAC_ADDRESS,
            (short) (OPTIONAL | 1), NO_IDX, };
    ...
    public static final short[] STRUCT_UWB_REGULATORY_INFO = { TAG_INFORMATION_SOURCE,
            (short) (MANDATORY | 1), NO_IDX, TAG_OUTDOOR_PERMITTED, (short) (MANDATORY | 1), NO_IDX,
            TAG_COUNTRY_CODE, (short) (MANDATORY | 2), NO_IDX, TAG_TIMESTAMP,
            (short) (MANDATORY | 4), NO_IDX, TAG_CHANNEL5, (short) (OPTIONAL | 1), NO_IDX,
            TAG_CHANNEL6, (short) (OPTIONAL | 1), NO_IDX, TAG_CHANNEL7, (short) (OPTIONAL | 1),
            NO_IDX, TAG_CHANNEL8, (short) (OPTIONAL | 1), NO_IDX, TAG_CHANNEL9,
            (short) (OPTIONAL | 1), NO_IDX, TAG_CHANNEL10, (short) (OPTIONAL | 1), NO_IDX,
            TAG_CHANNEL11, (short) (OPTIONAL | 1), NO_IDX, TAG_CHANNEL12, (short) (OPTIONAL | 1),
            NO_IDX, TAG_CHANNEL13, (short) (OPTIONAL | 1), NO_IDX, TAG_CHANNEL14,
            (short) (OPTIONAL | 1), NO_IDX, };
    ...
    public static final short[] STRUCT_UWB_STATIC_RANGING_INFO = { TAG_VENDOR_ID,
            (short) (MANDATORY | 2), NO_IDX, TAG_STATIC_STS_IV, (short) (MANDATORY | 6), NO_IDX, };
    ...
    public static final short[] STRUCT_UWB_SECURE_RANGING_INFO = { TAG_SESSION_KEY_INFO,
            (short) (CONDITIONAL | MAX | SESSION_KEY_INFO_MAX_SIZE), NO_IDX,
            TAG_RESPONDER_SPECIFIC_SUB_SESSION_KEY_INFO,
            (short) (CONDITIONAL | MAX | RESPONDER_SPECIFIC_SUB_SESSION_KEY_INFO_MAX_SIZE), NO_IDX,
            TAG_SUS_ADDITIONAL_PARAMS,
            (short) (CONDITIONAL | MAX | IMPL_MAX_SUS_ADDITIONAL_PARAMS_SIZE), NO_IDX, };
    public static final short TAG_UWB_CONTROLEE_INFO_VERSION = (short) 0x80;
    public static final short[] STRUCT_UWB_CONTROLEE_INFO = { TAG_UWB_CONTROLEE_INFO_VERSION,
            (short) (CONDITIONAL | 2), NO_IDX, TAG_UWB_CAPABILITY,
            (short) (CONDITIONAL | MAX | MAX_UWB_CAPABILITY_SIZE), STRUCT_UWB_CAPABILITY_IDX,
            TAG_UWB_CONTROLEE_PREF, (short) (OPTIONAL | MAX | MAX_UWB_CAPABILITY_SIZE),
            STRUCT_UWB_CONTROLEE_PREF_IDX, TAG_UWB_STATIC_RANGING_INFO,
            (short) (OPTIONAL | MAX | 16), STRUCT_UWB_STATIC_RANGING_INFO_IDX,
            TAG_UWB_SECURE_RANGING_INFO,
            (short) (OPTIONAL | MAX | IMPL_MAX_SECURE_RANGING_INFO_SIZE),
            STRUCT_UWB_SECURE_RANGING_INFO_IDX, TAG_UWB_REGULATORY_INFO,
            (short) (OPTIONAL | MAX | MAX_UWB_REGULATORY_SIZE), STRUCT_UWB_REGULATORY_INFO_IDX, };
    ...
    public static final short[] STRUCT_FIRA_SC_CRED = { TAG_FIRA_SC_SYMMETRIC_KEY_SET,
            (short) (CONDITIONAL | MAX | MAX_FIRA_SC_SYMMETRIC_KEY_SET_SIZE),
            STRUCT_FIRA_SC_SYMMETRIC_KEY_SET_IDX, TAG_FIRA_SC_ASYMMETRIC_KEY_SET,
            (short) (CONDITIONAL | MAX | MAX_FIRA_SC_ASYMMETRIC_KEY_SET_SIZE),
            STRUCT_FIRA_SC_ASYMMETRIC_KEY_SET_IDX, TAG_FIRA_SC_SYMMETRIC_BASE_KEY,
            (short) (CONDITIONAL | MAX | 32), STRUCT_FIRA_SC_SYMMETRIC_BASE_KEY_IDX,
    ...
    public static final short[] ENUM_FIRA_SC_KEY_USAGE = { VAL_FIRA_KEY_USAGE_REMOTE,
            VAL_FIRA_KEY_USAGE_LOCAL, };
    public static final short[] ENUM_FIRA_SC_KEY_TYPE = { VAL_ECC_NIST_P_256, };
    public static final short[] ENUM_FIRA_SC_SYMMETRIC_CH_ID = { VAL_SC1, VAL_SC1_PRIVACY_KEY_SET,
            VAL_SC2, VAL_SC2_PRIVACY_KEY_SET, };
    public static final short[] ENUM_FIRA_SC_ASYMMETRIC_CH_ID = { VAL_SC2, };
    public static final short[] ENUM_FIRA_SC_SYMMETRIC_BASE_KEY_CH_ID = { VAL_SC1, VAL_SC2, };
    ...
    public static final short[] STRUCT_FIRA_SC_SYMMETRIC_BASE_KEY = {
            ...
            ENUM_FIRA_SC_SYMMETRIC_BASE_KEY_CH_ID_IDX, TAG_FIRA_SC_KEY_USAGE,
            (short) (OPTIONAL | 1), ENUM_FIRA_SC_KEY_USAGE_IDX, TAG_FIRA_SC_SYMMETRIC_BASE_KEY_KVN,
            (short) (MANDATORY | 1), NO_IDX, TAG_FIRA_SC_SYMMETRIC_BASE_KEY_VALUE,
            (short) (MANDATORY | 16), NO_IDX, };
    public static final short[] STRUCT_ADF_PROV_SYMMETRIC_KEY_SET = { TAG_ADF_PROV_SEC_CH_ID,
            (short) (MANDATORY | 1), ENUM_ADF_PROV_SYMMETRIC_CH_ID_IDX, TAG_ADF_PROV_SEC_CH_KVN,
            (short) (MANDATORY | 1), NO_IDX, TAG_ADF_PROV_SYM_ENC_KEY, (short) (MANDATORY | 16),
            NO_IDX, TAG_ADF_PROV_SYM_MAC_KEY, (short) (MANDATORY | 16), NO_IDX, };

    public static final short[] STRUCT_ADF_PROV_ASYMMETRIC_KEY_SET = { TAG_ADF_PROV_SEC_CH_ID,
            (short) (MANDATORY | 1), ENUM_ADF_PROV_ASYMMETRIC_CH_ID_IDX, TAG_ADF_PROV_SEC_KEY_TYPE,
            (short) (MANDATORY | 1), ENUM_ADF_PROV_CH_KEY_TYPE_IDX, TAG_ADF_PROV_SEC_CH_KVN,
            (short) (MANDATORY | 1), NO_IDX, TAG_ADF_PROV_CA_PUB_KEY,
            (short) (MANDATORY | MAX | 65), NO_IDX, };
    public static final short[] STRUCT_FIRA_SC_SYMMETRIC_KEY_SET = { TAG_FIRA_SC_CH_ID,
            (short) (MANDATORY | 1), ENUM_FIRA_SC_SYMMETRIC_CH_ID_IDX, TAG_FIRA_SC_KEY_USAGE,
            (short) (OPTIONAL | 1), ENUM_FIRA_SC_KEY_USAGE_IDX, TAG_FIRA_SC_KVN,
            (short) (MANDATORY | 1), NO_IDX, TAG_FIRA_SC_SYM_ENC_KEY, (short) (MANDATORY | 16),
            NO_IDX, TAG_FIRA_SC_SYM_MAC_KEY, (short) (MANDATORY | 16), NO_IDX, };
    public static final short[] STRUCT_FIRA_SC_ASYMMETRIC_KEY_SET = { TAG_FIRA_SC_CH_ID,
            (short) (MANDATORY | 1), ENUM_FIRA_SC_ASYMMETRIC_CH_ID_IDX, TAG_FIRA_SC_KEY_TYPE,
            (short) (MANDATORY | 1), ENUM_FIRA_SC_KEY_TYPE_IDX, TAG_FIRA_SC_KEY_USAGE,
            (short) (OPTIONAL | 1), ENUM_FIRA_SC_KEY_USAGE_IDX, TAG_FIRA_SC_KVN,
            (short) (MANDATORY | 1), NO_IDX, TAG_FIRA_SC_ADF_CA_PUB_KEY,
            (short) (MANDATORY | MAX | 65), NO_IDX, TAG_FIRA_SC_ADF_CA_PUB_CERT,
            (short) (MANDATORY | MAX | IMPL_MAX_FIRA_CERT_SIZE), NO_IDX,
            TAG_FIRA_SC_ADF_PRIVATE_KEY, (short) (MANDATORY | MAX | 32), NO_IDX, };

    // Instruction - Delete Adf
    public static final short[] DATA_DELETE_ADF_CMD = { TAG_OID,
            (short) (MANDATORY | MAX | MAX_OID_SIZE), NO_IDX, };
    ...
    public static final short[] DATA_IMPORT_ADF_CMD = { TAG_OID,
            (short) (OPTIONAL | MAX | MAX_OID_SIZE), NO_IDX, TAG_UWB_CONTROLEE_INFO,
            (short) (OPTIONAL | MAX | MAX_UWB_CONTROLEE_INFO_SIZE_PER_SLOT),
            STRUCT_UWB_CONTROLEE_INFO_IDX, TAG_IMPORT_ADF_ACCESS_CONDITIONS,
            (short) (CONDITIONAL | MAX | MAX_ACCESS_CONDITIONS_SIZE), NO_IDX, TAG_FIRA_SC_CRED,
            (short) (MANDATORY | UNORDERED | MAX | MAX_FIRA_SC_CRED_SIZE), STRUCT_FIRA_SC_CRED_IDX,
    ...
    public static final short[] DATA_SWAP_ADF_ACQUIRE_CMD = {
            // TAG_SWAP_ADF_STATIC_STS, (short) (CONDITIONAL | MAX |
            // IMPL_MAX_SWAP_ADF_STATIC_STS_SIZE),
            // STRUCT_SWAP_ADF_STATIC_STS_IDX,
            TAG_SWAP_ADF_SECURE_BLOB, (short) (CONDITIONAL | MAX | MAX_SWAP_ADF_SECURE_BLOB_SIZE),
            NO_IDX, };
    public static final short[] STRUCT_SWAP_ADF_STATIC_STS = { TAG_OID,
            (short) (MANDATORY | MAX | MAX_OID_SIZE), NO_IDX, TAG_UWB_CONTROLEE_INFO,
            (short) (MANDATORY | MAX | MAX_UWB_CONTROLEE_INFO_SIZE_PER_SLOT),
            STRUCT_UWB_CONTROLEE_INFO_IDX, };

    // This structure is used to decode the secure blob which is created by the
    // import adf command.
    public static final short[] STRUCT_SWAP_ADF_SECURE_BLOB = { TAG_UWB_CONTROLEE_INFO,
            (short) (OPTIONAL | MAX | MAX_UWB_CONTROLEE_INFO_SIZE_PER_SLOT),
            STRUCT_UWB_CONTROLEE_INFO_IDX, TAG_IMPORT_ADF_ACCESS_CONDITIONS,
            (short) (CONDITIONAL | MAX | MAX_ACCESS_CONDITIONS_SIZE), NO_IDX, TAG_FIRA_SC_CRED,
            (short) (MANDATORY | UNORDERED | MAX | MAX_FIRA_SC_CRED_SIZE), STRUCT_FIRA_SC_CRED_IDX,
            TAG_EXTENDED_OPTIONS, (short) (OPTIONAL | 4), NO_IDX, TAG_OID,
            (short) (MANDATORY | MAX | MAX_OID_SIZE), NO_IDX, };
    ...
    public static final short[] DATA_INITIATE_TRANSACTION = {
            ...
            NO_IDX,
            // Uncomment when multicast needs to be supported - controller role
            // TAG_OID, (short)(OPTIONAL | MAX |
            // IMPL_INIT_TRANSACTION_MAX_OID_COUNT*IMPL_MAX_OID_SIZE), NO_IDX,
            // TAG_OID, (short)(OPTIONAL | MAX |
            // IMPL_INIT_TRANSACTION_MAX_OID_COUNT*IMPL_MAX_OID_SIZE), NO_IDX,
            // TAG_OID, (short)(OPTIONAL | MAX |
            // IMPL_INIT_TRANSACTION_MAX_OID_COUNT*IMPL_MAX_OID_SIZE), NO_IDX,
    ...
    public static final short[] DATA_TUNNEL = { TAG_PROPRIETARY_CMD_TEMPLATE,
            (short) (MANDATORY | MAX | IMPL_MAX_PROPRIETARY_CMD_SIZE),
            STRUCT_PROPRIETARY_CMD_TEMPLATE_IDX, };
    public static final short[] STRUCT_PROPRIETARY_CMD_TEMPLATE = { TAG_PROPRIETARY_CMD_DATA,
            (short) (MANDATORY | MAX | IMPL_MAX_PROPRIETARY_CMD_SIZE), NO_IDX, };
    ...
    /*
     * // this can be used. public static final short[] DATA_TUNNEL_RESP = {
     * TAG_PROPRIETARY_RESP_TEMPLATE, MANDATORY,
     * STRUCT_PROPRIETARY_TUNNEL_RESP_TEMPLATE_IDX, };
     */
    public static final short[] STRUCT_PROPRIETARY_TUNNEL_RESP_TEMPLATE = {
            TAG_PROPRIETARY_RESP_STATUS, (short) (MANDATORY | 1), NO_IDX, TAG_PROPRIETARY_RESP_DATA,
            (short) (OPTIONAL | MAX | IMPL_MAX_PROPRIETARY_RESP_SIZE), NO_IDX, };
    ...
    public static final short[] DATA_DISPATCH_CMD = { TAG_PROPRIETARY_CMD_TEMPLATE,
            (short) (MANDATORY | MAX | IMPL_MAX_PROPRIETARY_CMD_SIZE),
            STRUCT_PROPRIETARY_CMD_TEMPLATE_IDX, };
    public static final short[] DATA_DISPATCH_RESP = { TAG_PROPRIETARY_RESP_TEMPLATE,
            (short) (MANDATORY | MAX | IMPL_MAX_PROPRIETARY_RESP_SIZE),
    ...
    public static final short[] ENUM_PROPRIETARY_RESP_NOTIFICATION_ID = {
            VAL_PROPRIETARY_RESP_NOTIFICATION_ID_OID, VAL_PROPRIETARY_RESP_NOTIFICATION_ID_NONE,
    ...
    public static final short[] ENUM_PROPRIETARY_DISPATCH_RESP_STATUS = {
            VAL_PROP_DISPATCH_RESP_STATUS_TRANS_SUCCESS, VAL_PROP_DISPATCH_RESP_STATUS_RET_PEER,
            VAL_PROP_DISPATCH_RESP_STATUS_RET_HOST, VAL_PROP_DISPATCH_RESP_STATUS_TRANS_ERROR, };
    public static final short[] STRUCT_PROPRIETARY_DISPATCH_RESP = { TAG_PROPRIETARY_RESP_STATUS,
            (short) (MANDATORY | 1), ENUM_PROPRIETARY_DISPATCH_RESP_STATUS_IDX,
            TAG_PROPRIETARY_RESP_DATA, (short) (OPTIONAL | MAX | IMPL_MAX_PROPRIETARY_RESP_SIZE),
            NO_IDX, TAG_PROPRIETARY_RESP_NOTIFICATION,
    ...
    public static final short[] STRUCT_PROPRIETARY_RESP_NOTIFICATION = {
            ...
            ENUM_PROPRIETARY_RESP_NOTIFICATION_ID_IDX, TAG_PROPRIETARY_RESP_NOTIFICATION_DATA,
    ...
    /*
     * // can be used public static final short[] DATA_GET_DATA_PA_LIST_RESP = {
     * TAG_PA_ID,(short)( MANDATORY | MAX | 16), NO_IDX, }; public static final
     * short[] DATA_GET_DATA_CERTS_RESP = { TAG_CERT, (short)(MANDATORY | MAX |
     * IMPL_MAX_FIRA_CERT_SIZE), NO_IDX, // Note: we do not parse the cert while
     * responding }; public static final short[] DATA_GET_DATA_STATIC_STS_RESP = {
     * TAG_STATIC_STS_SLOT_OID,(short)(MANDATORY | MAX | IMPL_MAX_OID_SIZE), NO_IDX,
     * };
     */
    // Store Data - uses DGI format.
    // Note: Main differences between BER-TLV and DGI TLV format is that tags is DGI
    // are always 2 bytes
    // and length is either 1 byte of 3 bytes (first byte is oxFF). In BER TLV, Tags
    // can very from
    // 1 to n bytes and the length is encoded differently. Also in BER TLV the 0 and
    // 0xFF is not used
    // as Tags and they can occur between two BER TLV DOs.

    public static final short[] DATA_STORE_DATA = { TAG_DGI_ADD_PA_LIST, OPTIONAL, NO_IDX,
            TAG_DGI_ERASE_PA_LIST, OPTIONAL, NO_IDX, TAG_DGI_ERASE_ADF, OPTIONAL, NO_IDX, };
    // Sizes
    ...
    public static final short[] ENUM_CP_DEVICE_ROLE = { VAL_CP_DEVICE_ROLE_RESPONDER,
    ...
    public static final short[] ENUM_CP_RANGING_METHOD = { VAL_CP_RM_ONE_WAY,
            VAL_CP_RM_SS_TWR_DEF_MODE, VAL_CP_RM_DS_TWR_DEF_MODE, VAL_CP_RM_SS_TWR_NON_DEF_MODE,
    ...
    public static final short[] ENUM_CP_STS_CONFIG = { VAL_CP_SC_STATIC_STS, VAL_CP_SC_DYNAMIC_STS,
    ...
    public static final short[] ENUM_CP_MULTI_NODE_MODE = { VAL_CP_ONE_TO_ONE, VAL_CP_ONE_TO_MANY,
            VAL_CP_MANY_TO_MANY, };
    public static final short VAL_CP_RT_INTERVAL = (short) 0;
    public static final short VAL_CP_RT_BLOCK = (short) 1;
    public static final short[] ENUM_CP_RANGING_TIME_STRUCT = { VAL_CP_RT_INTERVAL,
            VAL_CP_RT_BLOCK, };
    ...
    public static final short[] ENUM_CP_SCHEDULED_MODE = { VAL_CP_CONTENTION_BASED_RANGING,
    ...
    public static final short[] ENUM_CP_HOPPING_MODE = { VAL_CP_HM_DISABLE, VAL_CP_HM_ENABLE, };
    public static final short VAL_CP_BS_NO_BLOCK_STRIDING = (short) 0;
    public static final short VAL_CP_BS_SKIP_BLOCKS = (short) 1;
    public static final short[] ENUM_CP_BLOCK_STRIDING = { VAL_CP_BS_NO_BLOCK_STRIDING,
            VAL_CP_BS_SKIP_BLOCKS, };
    public static final short[] ENUM_CP_CHANNEL_NUMBER = { (short) 5, (short) 6, (short) 8,
            (short) 9, (short) 10, (short) 12, (short) 13, (short) 14, };
    ...
    public static final short[] ENUM_CP_RFRAME_CONFIG = { VAL_CP_RF_SP0, VAL_CP_RF_SP1,
            VAL_CP_RF_SP2, VAL_CP_RF_SP3, };
    public static final short VAL_CP_K_3 = (short) 0;
    public static final short VAL_CP_K_7 = (short) 1;
    public static final short[] ENUM_CP_CC_CONSTRAINT_LENGTH = { VAL_CP_K_3, VAL_CP_K_7, };
    public static final short VAL_CP_BPRF = (short) 0;
    public static final short VAL_CP_HPRF = (short) 1;
    public static final short[] ENUM_CP_PRF_MODE = { VAL_CP_BPRF, VAL_CP_HPRF, };
    public static final short[] ENUM_CP_PREAMBLE_CODE_INDEX = { (short) 9, (short) 10, (short) 11,
            (short) 12, // BPRF
    ...
    public static final short[] ENUM_CP_MAC_ADDRESS_MODE = { VAL_CP_MAC_ADDRESS_2_2,
            VAL_CP_MAC_ADDRESS_8_2, VAL_CP_MAC_ADDRESS_8_8, };
    public static final short[] ENUM_CP_KEY_ROTATION_RATE = { (short) 0, (short) 1, (short) 2,
    ...
    public static final short[] ENUM_CP_MAC_FCS_TYPE = { VAL_CP_FT_CRC_16, VAL_CP_FT_CRC_32, };
    public static final short VAL_CONFIG_AVAILABLE = (short) 1;
    public static final short VAL_CONFIG_NOT_AVAILABLE = (short) 0;
    public static final short[] ENUM_UWB_CONFIG_AVAILABLE = { VAL_CONFIG_NOT_AVAILABLE,
    ...
    public static final short IMPL_MAX_APPLET_ID_SIZE = (short) 16; // 5 bytes of RID and 11 bytes
                                                                    // of PIX
    ...
    public static final short[] STRUCT_UWB_CONFIG_PARAMS = { // All params are kept optional
            TAG_CP_FIRA_PHY_VERSION, (short) (MANDATORY | 2), NO_IDX, TAG_CP_FIRA_MAC_VERSION,
            (short) (MANDATORY | 2), NO_IDX, TAG_CP_DEVICE_ROLE, (short) (OPTIONAL | 1),
            ENUM_CP_DEVICE_ROLE_IDX, TAG_CP_RANGING_METHOD, (short) (OPTIONAL | 1),
            ENUM_CP_RANGING_METHOD_IDX, TAG_CP_STS_CONFIG, (short) (OPTIONAL | 1),
            ENUM_CP_STS_CONFIG_IDX, TAG_CP_MULTI_NODE_MODE, (short) (OPTIONAL | 1),
            ENUM_CP_MULTI_NODE_MODE_IDX, TAG_CP_RANGING_TIME_STRUCT, (short) (OPTIONAL | 1),
            ENUM_CP_RANGING_TIME_STRUCT_IDX, TAG_CP_SCHEDULED_MODE, (short) (OPTIONAL | 1),
            ENUM_CP_SCHEDULED_MODE_IDX, TAG_CP_HOPPING_MODE, (short) (OPTIONAL | 1),
            ENUM_CP_HOPPING_MODE_IDX, TAG_CP_BLOCK_STRIDING, (short) (OPTIONAL | 1),
            ENUM_CP_BLOCK_STRIDING_IDX, TAG_CP_UWB_INITIATION_TIME, (short) (OPTIONAL | 4), NO_IDX,
            ...
            TAG_CP_PRF_MODE, (short) (OPTIONAL | 1), ENUM_CP_PRF_MODE_IDX, TAG_CP_SP0_PHY_SET,
            (short) (OPTIONAL | 1), NO_IDX, TAG_CP_SP1_PHY_SET, (short) (OPTIONAL | 1), NO_IDX,
            TAG_CP_SP3_PHY_SET, (short) (OPTIONAL | 1), NO_IDX, TAG_CP_PREAMBLE_CODE_INDEX,
            (short) (OPTIONAL | 1), ENUM_CP_PREAMBLE_CODE_INDEX_IDX, TAG_CP_RESULT_REPORT_CONFIG,
            (short) (OPTIONAL | 1), NO_IDX, TAG_CP_MAC_ADDRESS_MODE, (short) (OPTIONAL | 1),
            ENUM_CP_MAC_ADDRESS_MODE_IDX, TAG_CP_CONTROLEE_SHORT_MAC_ADDRESS,
            (short) (OPTIONAL | 2), NO_IDX, TAG_CP_CONTROLLER_MAC_ADDRESS,
            (short) (OPTIONAL | MAX | 8), NO_IDX, TAG_CP_SLOTS_PER_RR, (short) (OPTIONAL | 1),
            NO_IDX, TAG_CP_MAX_CONTENTION_PHASE_LENGTH, (short) (OPTIONAL | 1), NO_IDX,
            TAG_CP_SLOT_DURATION, (short) (OPTIONAL | 2), NO_IDX, TAG_CP_RANGING_INTERVAL,
            (short) (OPTIONAL | 2), NO_IDX, TAG_CP_KEY_ROTATION_RATE, (short) (OPTIONAL | 1),
            ENUM_CP_KEY_ROTATION_RATE_IDX, TAG_CP_MAC_FCS_TYPE, (short) (OPTIONAL | 1),
            ENUM_CP_MAC_FCS_TYPE_IDX, TAG_CP_MAX_RR_RETRY, (short) (OPTIONAL | 2), NO_IDX, };

    public static final short[] STRUCT_UWB_SESSION_DATA = { TAG_UWB_SESSION_DATA_VERSION,
            (short) (MANDATORY | 2), NO_IDX, TAG_UWB_SESSION_ID, (short) (OPTIONAL | 4), NO_IDX,
            TAG_UWB_SUB_SESSION_ID, (short) (OPTIONAL | 4), NO_IDX, TAG_UWB_CONFIG_PARAMS, OPTIONAL,
            STRUCT_UWB_CONFIG_PARAMS_IDX, TAG_UWB_STATIC_RANGING_INFO, OPTIONAL,
            STRUCT_UWB_STATIC_RANGING_INFO_IDX, TAG_UWB_SECURE_RANGING_INFO, OPTIONAL,
            STRUCT_UWB_SECURE_RANGING_INFO_IDX, TAG_UWB_REGULATORY_INFO, OPTIONAL,
            STRUCT_UWB_REGULATORY_INFO_IDX, TAG_UWB_CONFIG_AVAILABLE, (short) (OPTIONAL | 1),
            ENUM_UWB_CONFIG_AVAILABLE_IDX, };

    public static final short[] DATA_LOCAL_PUT_DATA = { TAG_UWB_CONTROLEE_INFO,
            (short) (OPTIONAL | MAX | MAX_UWB_CONTROLEE_INFO_SIZE_PER_SLOT),
            STRUCT_UWB_CONTROLEE_INFO_IDX, TAG_UWB_SESSION_DATA,
            (short) (OPTIONAL | MAX | MAX_UWB_SESSION_DATA_SIZE), STRUCT_UWB_SESSION_DATA_IDX, };
    public static final short[] DATA_REMOTE_PUT_DATA = { TAG_TERMINATE_SESSION,
            (short) (OPTIONAL | 0), NO_IDX, TAG_UWB_CONTROLEE_INFO,
            (short) (OPTIONAL | MAX | MAX_UWB_CONTROLEE_INFO_SIZE_PER_SLOT),
            STRUCT_UWB_CONTROLEE_INFO_IDX, TAG_UWB_SESSION_DATA,
            (short) (OPTIONAL | MAX | MAX_UWB_SESSION_DATA_SIZE), STRUCT_UWB_SESSION_DATA_IDX,
            TAG_CMD_ROUTE_INFO, (short) (OPTIONAL | MAX | IMPL_MAX_CMD_ROUTE_INFO_SIZE),
            STRUCT_CMD_ROUTE_INFO_IDX, };
    public static final short[] ENUM_PA_CRED_TYPE = { VAL_ECC_NIST_P_256, };
