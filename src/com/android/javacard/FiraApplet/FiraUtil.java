...
public class FiraUtil {
  ...
  public static short getNextDGITag(byte[] buf, short index, short len,
      boolean skip, short[] retValues) {
    short end = (short)(index + len);
    if (len == 0) {
      return FiraSpecs.INVALID_VALUE;
    }
   ...
   *                  object - retValues[1] - tag id. - retValues[2] - tag length - retValues[3] =
   *                  start index of TLV value field.
