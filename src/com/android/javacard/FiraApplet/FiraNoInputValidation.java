...
public class FiraNoInputValidation {
    public static void assertOrderedStructure(byte[] buf, short start, short len,
            short[] exp, boolean skip, byte[] scratchPadBuf, short scratchPad, short[] retValues) {
    }
