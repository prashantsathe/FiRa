...
public class ScpConstant {
    ...
    public static final short BLOCK16  = (short) 16;
    public static final short LENGTH_BLOCK_AES  = BLOCK16;
    public static final short SC_SECRETE_LENGTH  = (short) (BLOCK16 * 2);
    public static final short EPHEMERAL_PK_SIZE  = (short) ((BLOCK16 * 4) + 1);
    public static final short EPHEMERAL_SK_SIZE  = (short) (BLOCK16 * 2);
