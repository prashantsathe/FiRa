...
public class Certificates {
    ...
    */
    ...
    public Certificates() {
        ...
        /*
        //TBD: size
        mBF20RegistryData = JCSystem.makeTransientByteArray((short) 512, JCSystem.CLEAR_ON_RESET);
        mBF20RegistryDataLength = JCSystem.makeTransientShortArray((short) 1, JCSystem.CLEAR_ON_RESET);
        */
        mCertificateKeyUsageStatus = JCSystem.makeTransientByteArray((short) 1,
                JCSystem.CLEAR_ON_RESET);
        mPkOceEcka = JCSystem.makeTransientByteArray((short) 65, JCSystem.CLEAR_ON_RESET);
        mPkOceEckaSize = JCSystem.makeTransientShortArray((short) 1, JCSystem.CLEAR_ON_RESET);
    }
     ...
     */
    public boolean verifyCert(byte[] buffer, short bufferOffset, short bufferLen,
            boolean checkCSN) {
        ...
        while (index < bufferLen) {
            ...
            switch (tag) {
                ...
                case TAG_KEY_USAGE:
                    ...
                    certStatus |= 0x8;
                    if (dataLen == 1)
                        mCertificateKeyUsageStatus[0] = buffer[(short) (offsetIndex - dataLen)];
                    else
                        mCertificateKeyUsageStatus[0] = buffer[(short) (offsetIndex - dataLen + 1)];
                    break;
