...
public class Scp11Lib {
    ...
    private Certificates mCertificate;
    ...
    private void Scp11LibInit(FiraClientContext firaClientContext) {
        ...
        mEPkOceEcka = JCSystem.makeTransientByteArray((short) 65, JCSystem.CLEAR_ON_RESET);
    ...
    private short deriveSessionKey(byte keyUsageQual, byte keyType, byte keyLength,
        ...
        short ShSLength = 0;
        short skSdEckaSize = ClientContext.getSkSdEcka(kVn, mKeySetBuff, (short) 0);
    ...
    public short parseAndVerifyCrtGenerateReceipt(byte[] buffer, short bufferOffset, short bufferLen,
        ...
        if (ClientContext.getSkSdEcka(kVn, mKeySetBuff, (short) 0) == (short) 0) {
    ...
    public boolean parseAndVerifySignature(byte[] buffer, short offset, short length,
        ...
        short pkCaKlocEcdsaSize = ClientContext.getPkCaKlocEcdsa(keyVersion, mKeySetBuff, (short) 0);
    ...
    public short wrap(byte[] buff, short buffOffset, short buffLen) {
        return mScp3Lib.wrap(msecurityLevel[0], buff, buffOffset, buffLen);
    }
    ...
    public short unwrap(byte[] buff, short buffOffset, short buffLen) {
        return mScp3Lib.unwrap(msecurityLevel[0], buff, buffOffset, buffLen);
    }
