...
public class ClientContext {
  ...
  public static boolean findOID(byte[] oidBuff, short oidBuffOffset, byte oidBuffLength) {
      return true;
  }
  ...
  public static short getADFdata(byte[] oidBuff, short oidBuffOffset, byte oidBuffLength, byte[] buffer,
          short bufferOffset) {
      return (short) (Util.arrayFill(buffer, bufferOffset, (short) 512, (byte) 0x02) - bufferOffset);
  }

  public static short getSessionId(byte[] oidBuff, short oidBuffOffset, byte oidBuffLength,  byte[] buffer,
          short bufferOffset) {
  ...
  public static short getUWBsessionKeyInfoBuffer(byte[] oidBuff, short oidBuffOffset, byte oidBuffLength,  byte[] buffer,
          short bufferOffset) {
      return (short) (Util.arrayFill(buffer, bufferOffset, (short) 64, (byte) 0x02) - bufferOffset);
  }

  public static short getLabel(byte[] oidBuff, short oidBuffOffset, byte oidBuffLength,  byte[] buffer,
          short bufferOffset) {
      buffer[bufferOffset++] = 0x01;
      buffer[bufferOffset++] = 0x02;
      buffer[bufferOffset++] = 0x03;
  ...
  public static short getAdfExtendedBytes(byte[] oidBuff, short oidBuffOffset, byte oidBuffLength,  byte[] buffer,
          short bufferOffset) {
      buffer[bufferOffset++] = 0x01;
      buffer[bufferOffset++] = (byte)0xA0;
      return (short) 2;
  }

  // Table 74/75/76 of CSML CR v0.9_v123-TWG-May28-NXP-CSMLTT-NXP_ab.pdf
  public static short getFiRaCert2(byte[] buffer, short bufferOffset) {
      short certSize = bufferOffset;

      // Default certificate TODO: remove it
  ...
  public static short getKeyOffet(byte scIdentifier, byte keyType, byte[] keySetBuff, short keySetBuffOffset,
          short keySetBuffLen) {
      short offset = -1;
      ...
      while (index < totalLen) {
          ...
          totalLengthByteCount = BerTlvParser.getTotalLengthBytesCount(keySetBuff, (short) (index + 1));
          ...
          index += (1 + totalLengthByteCount + BerTlvParser.getDataLength(keySetBuff, (short) (index + 1)));
      }
  ...
  public static short getPkCaKlocEcdsa(byte kvn, byte[] keyBuff, short keyBuffOffset) {
      ...
      // Default keys TODO: remove it
      // 0470cae1 25c051ef 3bb64feb df335fba 0c2d2782 d85337df 3ef904e9 2b744986 2bb56391 e433dcc7 dfafa19b
      // ff6723e0 92ff55b8 95202a77 08952730 ac0844b3 fa
  ...
  public static boolean selectAdf(byte[] mContextBuffer, short selectedOidOffset, byte b) {
